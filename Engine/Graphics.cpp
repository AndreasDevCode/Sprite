...
void Graphics::DrawSpriteNoChroma( int x,int y,const Surface& s )
{
	DrawSpriteNoChroma(x, y, s.GetRect(), s);
}

void Graphics::DrawSpriteNoChroma(int x, int y, const RectI& srcRect, const Surface& s)
{
	DrawSpriteNoChroma(x,y, srcRect, GetScreen(), s);
}

void Graphics::DrawSpriteNoChroma(int x, int y, RectI srcRect, const RectI& clip, const Surface& s)
{
	...
	for (int sy = srcRect.top; sy < srcRect.bottom; sy++)
	{
		...
		{
			PutPixel(x - srcRect.left +  sx, y -srcRect.top+ sy, s.GetPixel(sx, sy));
		}
	}
}
...
{
	DrawSprite(x, y, srcRect, GetScreen(), s, chroma);
}
void Graphics::DrawSprite(int x, int y, RectI srcRect, const RectI& clip, const Surface& s, Color chroma)
{
	...
	for (int sy = srcRect.top; sy < srcRect.bottom; sy++)
	{
		for (int sx = srcRect.left; sx < srcRect.right; sx++)
		{
			...
			if (srcPixel != chroma)
			{
				PutPixel(x - srcRect.left + sx, y - srcRect.top + sy, srcPixel);
			}
		}
	}
}
