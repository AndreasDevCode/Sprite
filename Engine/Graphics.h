...
public:
	...
	void DrawSpriteNoChroma( int x,int y,const RectI& srcRect, const Surface& s );
	void DrawSpriteNoChroma( int x,int y, RectI srcRect, const RectI& clip, const Surface& s );
